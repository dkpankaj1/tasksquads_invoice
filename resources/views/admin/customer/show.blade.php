                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center">
                                <div
                                    class="avatar-lg bg-primary rounded-circle d-flex align-items-center justify-content-center me-3">
                                    <i class="fas fa-user text-white fa-2x"></i>
                                </div>
                                <div>
                                    <h3 class="mb-1">{{ $customer->full_name }}</h3>
                                    <p class="text-muted mb-0">Customer ID:
                                        #{{ str_pad($customer->id, 6, '0', STR_PAD_LEFT) }}</p>
                                    <div class="mt-1">
                                        @if ($customer->active)
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <small class="text-muted">
                                {{ $analytics['payment_statistics']['unpaid_invoices'] + $analytics['payment_statistics']['partial_invoices'] }}
                                pending
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="text-center p-3 border rounded">
                                <h4 class="text-success mb-1">{{ $analytics['payment_statistics']['paid_invoices'] }}
                                </h4>
                        ...
                        <div class="col-6">
                            <div class="text-center p-3 border rounded">
                                <h4 class="text-warning mb-1">
                                    {{ $analytics['payment_statistics']['partial_invoices'] }}</h4>
                                <small class="text-muted">Partial Payments</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center p-3 border rounded">
                                <h4 class="text-danger mb-1">{{ $analytics['payment_statistics']['unpaid_invoices'] }}
                                </h4>
                        ...
                        <div class="col-6">
                            <div class="text-center p-3 border rounded">
                                <h4 class="text-primary mb-1">{{ $analytics['payment_statistics']['total_invoices'] }}
                                </h4>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-success"
                                    style="width: {{ $analytics['performance_metrics']['payment_efficiency'] }}%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#"><i
                                            class="fas fa-download me-2"></i>Export Chart</a></li>
                                <li><a class="dropdown-item" href="#"><i
                                            class="fas fa-print me-2"></i>Print</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('invoice.index', ['customer_id' => $customer->id]) }}"
